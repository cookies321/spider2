...
public class PageDownLoadUtil {
	...
	/**
	 * @Description 能够设置字符集编码
	 * @author 谢大磊
	 * @date 2017年12月13日 下午4:58:09
	 * @action httpClientDefultGet
	 * @return String
	 */
	public static String sendPostByEncoding(String url, String param, String encoding,Map<?,?>...maps){
		String key = "";
		PrintWriter out = null;
		BufferedReader in = null;
		String result = "";
	...
	public static void main(String[] args) throws Exception {
		...
		String url="http://www.tuniu.com/guide/d-sanya-906/jingdian/";
		String param="Resource=1408753&pageType=Sight";
		
		Map<String,String> header=new HashMap<String, String>();
		header.put("User-Agent", "Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Mobile Safari/537.36");
		...
		String httpClientGet = httpClientGet("http://www.tuniu.com/newguide/api/widget/render/?widget=ask.AskAndCommentWidget&params[poiId]=2853&params[page]=1");
